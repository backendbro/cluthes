...
function AssetsFaq() {
  return (
    <div className='flex flex-col space-y-4'>
        ...
        <div >
            <h2 className='mb-2 text-black font-semibold text-[.9rem] '>  What are the differences among the DoniCoin Main Account, Trading Account, Margin Account, Futures Account, and Financial Account?</h2>
