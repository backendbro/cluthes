  ...
  return (
    <div className='mt- flex flex-col space-y-8  md:flex-row md: justify-between md:items-end'>
        <div className='flex flex-col space-y-8'>
            ...
            <div className='flex items-center gap-2'>
                <Image src="https://assets.staticimg.com/kucoin-main-web/1.11.10/static/dashedCircle.63d836e1.svg" width={25} height={25} />
        ...
        <div className='flex gap-4 w-full md:w-[50%] lg:w-[40%]'>
            <button className='py-2 px-4 w-full rounded-md text-white bg-green '>Deposit</button>
            <button className='py-2 px-4 w-full rounded-md green bg-white border border-green-200 '>Buy Crypto</button>
            <button className='py-2 px-4 w-full rounded-md green bg-white border border-green-200 '>Widthdraw</button>
        </div>
    </div>
  )
}
